...
function YearbookSection() {
  ...
  return (
    <section id="services" className="relative overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-stone-100 via-stone-50 to-stone-100"></div>

      <div className="bg-stone-100 pt-32 pb-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#024334] mb-4 font-libre-baskerville tracking-tight">
              YEARBOOK AND FRAMES
            </h2>
            <p className="text-[#024334] text-lg font-poppins">
          ...
          <div className="relative">
            <div className="absolute top-0 right-0 z-20 transform translate-x-4 -translate-y-4">
              <div className="relative">
                <img
                  ...
                  className="w-24 h-32 sm:w-32 sm:h-44 md:w-40 md:h-56 object-cover rounded-lg shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500"
                />
            ...
            <div
              className="relative rounded-3xl p-8 sm:p-12 md:p-16 min-h-[400px] sm:min-h-[500px] md:min-h-[600px] flex flex-col justify-between overflow-hidden transition-all duration-700 ease-in-out"
              style={{
            ...
            >
              ...
              <div className="relative z-10">
                <div className="inline-block mb-6">
                  <span className="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold font-poppins tracking-[0.05em]">
                    {currentYearbook.theme}
                  </span>
                </div>

                <p className="text-white/90 text-lg sm:text-xl font-poppins max-w-md">
                  {currentYearbook.description}
                </p>
              </div>

              <div className="relative z-10 text-right">
                <h3 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold text-white font-libre-baskerville tracking-tight opacity-90">
                  {currentYearbook.year}
                </h3>
              </div>

              <div className="relative z-10 flex justify-between items-center mt-8">
                <button className="bg-white hover:bg-gray-100 text-gray-900 px-6 py-3 rounded-full font-poppins font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/30">
                  More...
                </button>
                <div className="flex items-center gap-3">
                  <button
                    onClick={prevSlide}
                    className="w-12 h-12 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-white/30"
            ...
            <div className="flex justify-center mt-8 gap-3">
              {yearbooks.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 ${
                    index === currentIndex
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-libre-baskerville">
                Past Yearbooks
              </h3>
      ...
      <div className="relative h-32 bg-gradient-to-b from-stone-100 to-transparent overflow-hidden">
